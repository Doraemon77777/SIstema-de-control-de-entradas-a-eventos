...
public class Venta {
    ...
    public Venta(String v1, String idUsuario, long idEvento, Comprador compr, String date, int cantidadBoletos, String vip, String efectivo, String confirmada, double total, Entrada[] entradaVendidas, Comprobante comprob) {
    }
